...
Question QuestionLoader::Load(string file_path, bool is_required)
{
    try
    {
      int question_index = getFileIndex(getFileName(file_path));
      ...
      for (int i = 0; i < n; i++) {
        ...
        return Question{question_index, questionText, image_path, answerText,
